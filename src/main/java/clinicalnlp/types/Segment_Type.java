...
public class Segment_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("clinicalnlp.types.Segment");
  ...
  public String getCode(int addr) {
      ...
      jcas.throwFeatMissing("code", "clinicalnlp.types.Segment");
  ...
  public String getCodeSystem(int addr) {
      ...
      jcas.throwFeatMissing("codeSystem", "clinicalnlp.types.Segment");
