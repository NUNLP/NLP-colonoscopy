...
public class LeftWindow extends Annotation {
  ...
  public final static int typeIndexID = JCasRegistry.register(LeftWindow.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected LeftWindow() {/* intentionally empty block */}
   ...
   */
  public LeftWindow(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public LeftWindow(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
