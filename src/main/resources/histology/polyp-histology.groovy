...
findingPatterns = [
    ...
    (~/(?i)(?s)SESSILE\s+SERRATED(\s+COLONIC)?\s+ADENOMA/):[group:0] << SESSILE_SERRATED_ADENOMA.map,
    (~/(?i)(?s)TRADITIONAL\s+SERRATED\s+ADENOMA/):[group:0] << TRADITIONAL_SERRATED_ADENOMA.map,
